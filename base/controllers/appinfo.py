...
class AppInfo(object):
	...
	def edit_submit(self, id, source_package, name, homepage, license, \
		...
		username = cherrypy.session['login_username']
		filename = os.path.join(cherrypy.request.app.base_dir, 'media/screens/%s_upload.png' % username)
		thumb_filename = os.path.join(cherrypy.request.app.base_dir, 'media/screens/%s_upload_t.png' % username)
		# There is a screenshot image to be uploaded
		if os.path.exists(filename):				
			screen_img_dir  = os.path.join(cherrypy.request.app.base_dir, "media/screens/%d" % id)
	...
	def upload_screenshot(self, userfile):
		...
		filename = os.path.join(cherrypy.request.app.base_dir\
			, 'media/screens/%s_upload.png' % username)
		thumb_filename = os.path.join(cherrypy.request.app.base_dir\
